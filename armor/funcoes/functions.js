...
const spinner2 = { 
  "interval": 150,
  "frames": ["CANAL: https://youtube.com/@igorplayer1"]}
...
const banner2 = cfonts.render(('M.Scheyot-DOMINA'), {
font: 'console',
align: 'center',
gradrient: [`${cor4}`,`${cor2}`], 
...
authorname = 'SAKURA-BOT-V6'
packname = '-SB-'
  
function addMetadata(packname, author) {	
if (!packname) packname = '-M.S-'; if (!author) author = 'SAKURA-BOT';	
...
chyt = `558581123181@s.whatsapp.net`
